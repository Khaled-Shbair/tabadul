...
class CustomShopProductsDepartment extends StatelessWidget with CustomToast {
  const CustomShopProductsDepartment({
  ...
  Widget build(BuildContext context) {
    initShopProducts();
    return BlocProvider<ShopProductsBloc>.value(
      value: instance<ShopProductsBloc>()
        ..add(GetAllProducts(departmentName: tableName)),
      child: Scaffold(
        body: Padding(
                ...
                return Column(
                  ...
                  children: [
                    ...
                    GridView.builder(
                      ...
                      padding:
                          EdgeInsetsDirectional.only(top: ManagerHeight.h20),
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 2,
                        childAspectRatio:
                            ManagerWidth.w136 / ManagerHeight.h154,
