...
class DeliveryTimeScreen extends StatelessWidget with CustomToast {
    ...
    return BlocListener(
      listener: (context, state) {
        if (state is BuyProductFailure) {
          ...
          Navigator.of(context, rootNavigator: true).pop();
          Navigator.pushReplacementNamed(context, Routes.waitForPickupScreen);
          disposeDeliveryTime();
          disposeBuyProduct();
        }
      },
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: CustomButton(
                  onPressed: () {
                    context.read().add(BuyProductProcess(tableName, productId));
                  },
                  child: Text(
                    ManagerStrings.done,
