const Map<String, String> en = {
  'fair_return_policy': 'Fair return policy',
  'on_boarding1':
      'We guarantee to return the goods without paying any fees and you can\nreturn any goods you no longer want with only the\ndelivery cost',
