...
class ManagerFontsSizes {
  ...
  static double f24 = SizeUtil.setFontSize(24);
  static double f26 = SizeUtil.setFontSize(26);
  static double f28 = SizeUtil.setFontSize(28);
  static double f30 = SizeUtil.setFontSize(30);
}
